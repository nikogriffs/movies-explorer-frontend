        ...
        <ul className="portfolio-links__list">
          ...
          <li className="portfolio-links__item">
            <a className="portfolio-link"
              href="https://nikogriffs.github.io/how-to-learn/" target="_blank" rel="noreferrer">
          ...
          <li className="portfolio-links__item">
            <a className="portfolio-link"
              href="https://nikogriffs.github.io/russian-travel/" target="_blank" rel="noreferrer">
          ...
          <li className="portfolio-links__item">
            <a className="portfolio-link"
              href="https://mesto.nikogriffs.nomoredomains.monster/" target="_blank" rel="noreferrer">
